...
<html>
  ...
  session_start();
    ...
    <body style="margin:0 auto;width:960px;background:#EAEAEA">
        ...
        <h2 style="font-size:38px;text-align:center">Supper global varriable $_COOKIE</h2>
        ...
        <?php
            ...
            setcookie("visited","1",time()+84600,"/") or die('cokkies not set');
                echo "cookies done";
                }
            else{
                echo "cookies already set";
